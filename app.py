...
harmful_db = {
    # --- НОВИ ВРЕДНИ СЪСТАВКИ ОТ ЛУКАНКА МАЙСТОР ---

    "Натриев нитрит (E250) - консервант": {
        "bg": ["натриев нитрит"],
        "en": ["sodium nitrite"],
        "e": ["E250"],
        "description": "Силно токсичен в големи количества. При нагряване образува канцерогенни нитрозамини. Свързва се с рак на дебелото черво, стомаха и панкреаса. Може да причини метхемоглобинемия (синьо оцветяване на кожата и задух). Световната здравна организация (WHO) го класифицира като 'вероятно канцерогенен за хората'.",
        "used_for": "Консервант и фиксатор на розовия цвят в месни продукти (луканки, салами, шунка, бекон, колбаси)"
    },
    "Калиев нитрат (E252) - консервант (добавка)": {
        "bg": ["калиев нитрат", "еликсир", "калиева селитра"],
        "en": ["potassium nitrate", "saltpeter"],
        "e": ["E252"],
        "description": "В организма се превръща в нитрити, които образуват канцерогенни нитрозамини. Свързва се с рак на стомаха и хранопровода. При високи дози може да причини метхемоглобинемия и задушаване. Ограничен в много държави поради опасения за канцерогенност.",
        "used_for": "Консервант в сурово-сушени месни продукти (луканки, бутове, шунки), твърди сирена"
    },
    "Натриев аскорбат (E301) - антиоксидант (добавка)": {
        "bg": ["натриев аскорбат", "натриева сол на аскорбиновата киселина"],
        "en": ["sodium ascorbate", "sodium L-ascorbate"],
        "e": ["E301"],
        "description": "Самият по себе си е безопасен като форма на витамин С. Основният риск е, че в месните продукти, съдържащи нитрити и нитрати, може да УСКОРИ образуването на канцерогенни нитрозамини. Препоръчва се да се избягва в комбинация с нитрити.",
        "used_for": "Антиоксидант в месни продукти (предпазва от гранясване и запазва цвета), плодови сокове, бира"
    },
    "Лактоза (млечна захар) - алерген": {
        "bg": ["лактоза", "млечна захар"],
        "en": ["lactose", "milk sugar"],
        "e": [],
        "description": "При хора с лактозна непоносимост (недостиг на ензима лактаза) причинява подуване на корема, газове, диария, спазми и гадене. При по-тежки случаи може да доведе до дехидратация и загуба на тегло. Също така е алерген за хора с алергия към млечни продукти.",
        "used_for": "Подсладител и пълнител в месни продукти, хлебни изделия, млечни продукти, лекарства"
    },
    "Глутен (от пшеница) - алерген": {
        "bg": ["глутен", "пшеничен глутен", "пшенично брашно"],
        "en": ["gluten", "wheat gluten"],
        "e": [],
        "description": "При хора с цьолиакия (автоимунно заболяване) причинява увреждане на тънките черва, недохранване, анемия, остеопороза и повишен риск от лимфом. При не-цьолиакийна чувствителност към глутен може да предизвика умора, главоболие, ставни болки и кожни обриви.",
        "used_for": "Подобрител на текстурата в месни продукти, хляб, тестени изделия, сосове"
    },
    "Соя (соев протеин) - алерген": {
        "bg": ["соя", "соев протеин", "соево брашно", "соп"],
        "en": ["soy", "soy protein", "soybean", "soya"],
        "e": [],
        "description": "Един от осемте най-чести алергена. Може да причини леки реакции (обрив, сърбеж, кихане) до тежки анафилактични реакции (затруднено дишане, спадане на кръвното налягане, загуба на съзнание). Чести и при кръстосани алергии с фъстъци и бобови.",
        "used_for": "Пълнител и подобрител на текстурата в месни продукти, хлебни изделия, сосове, веган продукти"
    },
